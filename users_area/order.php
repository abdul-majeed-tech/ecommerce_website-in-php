...
// getting total items and total price of all items
 ...
 $status='pending';
 $product_count=mysqli_num_rows($result_cart_price);
...
values ($user_id,$subtotal,$invoice_number,$product_count,NOW(),'$status')";
$result_query=mysqli_query($con,$insert_orders);
if($result_query){
    echo "<script>alert('Orders submittes successfully')</script>";
